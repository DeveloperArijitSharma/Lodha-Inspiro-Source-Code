  ...
  Widget _buildClassworkScreenContent(Size size, double padding, bool isDark) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildHeader('Classwork & Tasks', textColor),
          SizedBox(height: size.height * 0.025),
          _buildTaskCard('Math Homework 10-A', 'Due Today at 5:00 PM',
              _accentBlue, isDark),
          SizedBox(height: size.height * 0.015),
          _buildTaskCard(
              'Science Project Draft', 'Due Tomorrow', _accentBlue, isDark),
        ],
      ),
    );
  }
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildGlassNavItem(
                      1, Icons.assignment_outlined, 'Classwork', isDark),
                  _buildGlassNavItem(
