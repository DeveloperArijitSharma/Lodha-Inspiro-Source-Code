...
class _SearchBox extends StatelessWidget {
  final TextEditingController controller; final bool dark;
...
class _AddButton extends StatelessWidget {
  final VoidCallback onPressed; const _AddButton({required this.onPressed});
