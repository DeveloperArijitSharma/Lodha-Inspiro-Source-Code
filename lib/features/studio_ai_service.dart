...
class StudioAiService {
  ...
  Future<String> generate(String prompt) async {
    ...
    if (keys.isEmpty) throw GeminiException('Studio AI has no Groq key. Configure GROQ_API_KEY_1 through GROQ_API_KEY_10.');
    ...
    if (allCooling) throw GeminiException('Studio AI is temporarily busy. Please try again.');
