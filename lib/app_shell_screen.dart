...
class _AppShellScreenState extends State<AppShellScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _GlassNavigation(
        index: _index,
        dark: dark,
        onSelect: _setIndex,
      ),
  ...
  Widget _chatPage() {
    final type = _chatFilter == 0
        ...
        : _chatFilter == 1
            ...
            : 'group';
    final chats = _chats
        .where((chat) => chat['chat_type'] == type)
        .toList();
        ...
        child: BackdropFilter(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: dark ? Colors.black.withOpacity(.58) : Colors.white.withOpacity(.70),
              border: Border(
                right: BorderSide(color: dark ? Colors.white12 : Colors.white),
              ),
            ),
            child: SafeArea(
              child: Padding(
                      ...
                      _DrawerButton(
                        ...
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const TeacherRecordingsScreen(),
                            ),
                          );
                        },
                      ),
  ...
  Future<void> _showSettings(bool dark) async {
    await showModalBottomSheet<void>(
      ...
      builder: (_) => Container(
        ...
        decoration: BoxDecoration(
          color: dark
              ? const Color(0xFF111722).withOpacity(.96)
          ...
          child: ListView(
            ...
            children: [
              ...
              AdvancedSettingsSection(
                isDark: dark,
                accentColor: const Color(0xFF4B8DFF),
              ),
            ],
          ),
        ),
    ...
    return Stack(
      children: [
        Positioned(
          top: -140,
          right: -100,
          child: _orb(330, const Color(0xFF4B8DFF)),
        ),
        Positioned(
          top: 250,
          left: -170,
          child: _orb(340, const Color(0xFF9A7BFF)),
        ),
        Positioned(
          bottom: -180,
          right: -120,
          child: _orb(380, const Color(0xFF54D6BE)),
        ),
        Positioned.fill(
          child: BackdropFilter(
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: selected
                ? const Color(0xFF4B8DFF).withOpacity(.16)
                : Colors.transparent,
            ...
            children: [
              Icon(
                ...
                color: selected
                    ...
                    : Theme.of(context).iconTheme.color?.withOpacity(.62),
                size: 21,
              ),
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: selected ? const Color(0xFF4B8DFF) : null,
                ),
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Icon(icon, color: const Color(0xFF4B8DFF)),
...
class _ChatFilters extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const labels = ['Classmates', 'Teachers', 'Groups'];
    return Row(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: selected == entry.key
                      ? const Color(0xFF4B8DFF).withOpacity(.15)
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListTile(
        leading: Icon(
          icon,
          color: destructive ? Colors.redAccent : const Color(0xFF4B8DFF),
        ),
        title: Text(
          title,
          style: TextStyle(
